...
namespace DotnetPractice.Controllers
{
    ...
    {
        private readonly DotnetPracticeContext _context;

        public EnrollmentsController(DotnetPracticeContext context)
        {
            _context = context;
        }
        ...
        {
            var dotnetPracticeContext = _context.Enrollment.Include(e => e.Course).Include(e => e.Student);
            return View(await dotnetPracticeContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DotnetPracticeContext.Enrollment'  is null.");
            }
            var enrollment = await _context.Enrollment.FindAsync(id);
            if (enrollment != null)
            {
